...
import { TeamLeader } from "../../teamLeader/base/TeamLeader";
...
export class TeamResolverBase {
  ...
  async createTeam(@graphql.Args() args: CreateTeamArgs): Promise<Team> {
    return await this.service.createTeam({
      ...
      data: {
        ...
        teamLeader: args.data.teamLeader
          ? {
              connect: args.data.teamLeader,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => TeamLeader, {
    nullable: true,
    name: "teamLeader",
  })
  @nestAccessControl.UseRoles({
  ...
  async getTeamLeader(
    ...
    const result = await this.service.getTeamLeader(parent.id);
